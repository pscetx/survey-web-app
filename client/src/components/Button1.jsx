...
const Button1 = () => {
  return (
    <button type="submit" className="flex justify-center shadow-xl gap-2 text-primary items-center text-2xl bg-white backdrop-blur-md font-semibold isolation-auto border-2 border-secondary before:absolute before:w-full before:transition-all before:duration-700 before:hover:w-full before:-left-full before:hover:left-0 before:rounded-full before:bg-primary hover:text-gray-50 before:-z-10 before:aspect-square before:hover:scale-150 before:hover:duration-700 relative z-10 px-4 py-2 overflow-hidden border-2 rounded-xl group">
      LÀM BÀI NGAY
